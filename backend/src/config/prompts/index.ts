...
import { STORM_AT_SEA_PROMPT } from './storm-at-sea.prompt';
import { DRUNKARDS_PATH_PROMPT } from './drunkards-path.prompt';
import { FEATHERED_STAR_PROMPT } from './feathered-star.prompt';
import { GRANDMOTHERS_FLOWER_GARDEN_PROMPT } from './grandmothers-flower-garden.prompt';
import { DOUBLE_WEDDING_RING_PROMPT } from './double-wedding-ring.prompt';
import { PICKLE_DISH_PROMPT } from './pickle-dish.prompt';
import { COMPLEX_MEDALLION_PROMPT } from './complex-medallion.prompt';
