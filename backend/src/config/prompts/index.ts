...
import { FOUR_PATCH_PROMPT } from '../patterns/four-patch/prompt';
import { NINE_PATCH_PROMPT } from '../patterns/nine-patch/prompt';
import { HALF_SQUARE_TRIANGLES_PROMPT } from '../patterns/half-square-triangles/prompt';
import { HOURGLASS_PROMPT } from '../patterns/hourglass/prompt';
...
import { MOSAIC_STAR_PROMPT } from '../patterns/mosaic-star/prompt';
...
export const PATTERN_PROMPTS: Record<string, PatternPrompt> = {
  ...
  'mosaic-star': MOSAIC_STAR_PROMPT,
