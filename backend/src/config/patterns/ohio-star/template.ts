export const OHIO_STAR_TEMPLATE = `
    ...
    <!-- COLOR1 = Background, COLOR2 = Star Points, COLOR3 = Center, COLOR4 = Accent Star Points -->
    ...
    <!-- Star triangles (corner) stay COLOR2 -->
    ...
    <!-- Star triangles (side) use COLOR4 accent -->
    <polygon points="33.33,0 50,16.67 66.67,0" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="66.67,0 50,16.67 66.67,33.33" fill="COLOR1" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="33.33,33.33 50,16.67 66.67,33.33" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
    ...
    <!-- Star triangles (side) use COLOR4 accent -->
    <polygon points="100,33.33 83.33,50 100,66.67" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="100,66.67 83.33,50 66.67,66.67" fill="COLOR1" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="66.67,33.33 83.33,50 66.67,66.67" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
    ...
    <!-- Star triangles (side) use COLOR4 accent -->
    <polygon points="33.33,100 50,83.33 66.67,100" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="66.67,100 50,83.33 66.67,66.67" fill="COLOR1" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="33.33,66.67 50,83.33 66.67,66.67" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
    ...
    <!-- Star triangles (side) use COLOR4 accent -->
    <polygon points="0,33.33 16.67,50 0,66.67" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="0,66.67 16.67,50 33.33,66.67" fill="COLOR1" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="33.33,33.33 16.67,50 33.33,66.67" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
`;
