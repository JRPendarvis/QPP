...
export const FEATHERED_STAR_4 = `
    ...
    <!-- FEATHERS - alternating COLOR1 and COLOR3 -->
    <!-- Top -->
    <polygon points="20,20 27,20 23.5,13" fill="COLOR1" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="27,20 34,20 30.5,13" fill="COLOR3" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="34,20 40,20 37,13" fill="COLOR1" stroke="#ccc" stroke-width="0.5"/>
...
export const FEATHERED_STAR_5 = `
    ...
    <!-- Center square - COLOR5 -->
    <rect x="40" y="40" width="20" height="20" fill="COLOR5" stroke="#ccc" stroke-width="0.5"/>
    
    <!-- Main star points - COLOR1 -->
    <polygon points="40,20 60,20 50,40" fill="COLOR1" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="80,40 80,60 60,50" fill="COLOR1" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="40,80 60,80 50,60" fill="COLOR1" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="20,40 20,60 40,50" fill="COLOR1" stroke="#ccc" stroke-width="0.5"/>
    
    <!-- Diagonal star points - COLOR1 -->
    <polygon points="20,20 40,20 40,40" fill="COLOR1" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="20,20 20,40 40,40" fill="COLOR1" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="80,20 60,20 60,40" fill="COLOR1" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="80,20 80,40 60,40" fill="COLOR1" stroke="#ccc" stroke-width="0.5"/>
    ...
    <!-- FEATHERS - alternating COLOR3 and COLOR4 -->
    <!-- Top -->
    <polygon points="20,20 27,20 23.5,13" fill="COLOR3" stroke="#ccc" stroke-width="0.5"/>
    <polygon points="27,20 34,20 30.5,13" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
    ...
    <polygon points="66,20 73,20 69.5,13" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
    ...
    <polygon points="27,80 34,80 30.5,87" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
    ...
    <polygon points="66,80 73,80 69.5,87" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
    ...
    <polygon points="20,27 20,34 13,30.5" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
    ...
    <polygon points="20,66 20,73 13,69.5" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
    ...
    <polygon points="80,27 80,34 87,30.5" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
    ...
    <polygon points="80,66 80,73 87,69.5" fill="COLOR4" stroke="#ccc" stroke-width="0.5"/>
