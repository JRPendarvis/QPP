...
- When blocks are tiled and rotated, secondary patterns emerge (Barn Raising, Straight Furrows, Courthouse Steps, etc.)
- Four rounds of strips create the classic proportions`,

  fabricRoleGuidance: `For Log Cabin specifically:
- COLOR1: Center "hearth" square — traditionally red or yellow to symbolize fire/light
- Light side colors (COLOR2, COLOR3, COLOR4): Top and right strips — use lighter values
- Dark side colors (COLOR5, COLOR6, COLOR7, COLOR8): Bottom and left strips — use darker values
- More fabrics = more variety within each side, alternating by round
- Strong light/dark contrast creates the diagonal effect when blocks are tiled`,
