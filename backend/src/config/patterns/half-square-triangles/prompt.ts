...
- Multiple HST units tile together to showcase more fabrics (2-8 colors)
- Colors are always paired within each unit
...
- Rotation and arrangement of HSTs creates infinite design possibilities`,
  ...
  fabricRoleGuidance: `For Half-Square Triangles specifically:
- Colors are used in pairs — each pair shares one HST unit
- 2 colors: Single HST with COLOR1/COLOR2
- 4 colors: Two pairs (COLOR1/COLOR2 and COLOR3/COLOR4)
- 6 colors: Three pairs
- 8 colors: Four unique pairs, one per quadrant
- Contrast within each pair defines the diagonal; contrast between pairs adds variety`,
