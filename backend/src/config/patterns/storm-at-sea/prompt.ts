...
- The "movement" comes from how the diamonds connect across block boundaries`,
  ...
  fabricRoleGuidance: `For Storm at Sea specifically:
...
- High contrast between COLOR1 and COLOR2 strengthens the wave illusion
- COLOR3 should contrast with COLOR1 to make the nested diamonds visible`,
