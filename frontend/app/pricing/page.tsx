      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <p className="text-xl max-w-3xl mx-auto mb-4" style={{color: '#1F2937'}}>
            Start free and upgrade anytime to unlock more monthly credits, more monthly downloads, advanced features, and priority support. Fabric Hold remains available as a separate add-on for users who want to store their fabric stash.
          </p>
