...
// Pattern options with accurate fabric count recommendations
...
const PATTERN_OPTIONS: Record<string, { id: string; name: string; recommendedFabricCount?: number | { min: number; max: number } }[]> = {
  beginner: [
    { id: 'simple-squares', name: 'Simple Squares', recommendedFabricCount: { min: 1, max: 8 } },
  ...
  advanced_beginner: [
    ...
    { id: 'hourglass', name: 'Hourglass', recommendedFabricCount: { min: 2, max: 4 } },
    { id: 'bow-tie', name: 'Bow Tie', recommendedFabricCount: { min: 2, max: 3 } },
  ],
  intermediate: [
    { id: 'flying-geese', name: 'Flying Geese', recommendedFabricCount: { min: 2, max: 8 } },
    { id: 'pinwheel', name: 'Pinwheel', recommendedFabricCount: { min: 2, max: 4 } },
    { id: 'log-cabin', name: 'Log Cabin', recommendedFabricCount: { min: 3, max: 8 } },
    { id: 'sawtooth-star', name: 'Sawtooth Star', recommendedFabricCount: { min: 2, max: 3 } },
    { id: 'ohio-star', name: 'Ohio Star', recommendedFabricCount: { min: 2, max: 3 } },
    { id: 'churn-dash', name: 'Churn Dash', recommendedFabricCount: { min: 2, max: 3 } },
  ],
  advanced: [
    { id: 'lone-star', name: 'Lone Star', recommendedFabricCount: { min: 3, max: 8 } },
    { id: 'mariners-compass', name: "Mariner's Compass", recommendedFabricCount: { min: 4, max: 6 } },
    { id: 'new-york-beauty', name: 'New York Beauty', recommendedFabricCount: { min: 4, max: 5 } },
  ...
  expert: [
    ...
    { id: 'grandmothers-flower-garden', name: "Grandmother's Flower Garden", recommendedFabricCount: { min: 3, max: 8 } },
    { id: 'double-wedding-ring', name: 'Double Wedding Ring', recommendedFabricCount: { min: 3, max: 4 } },
    { id: 'pickle-dish', name: 'Pickle Dish', recommendedFabricCount: { min: 4, max: 6 } },
    { id: 'complex-medallion', name: 'Complex Medallion', recommendedFabricCount: { min: 3, max: 8 } },
  ],
};
